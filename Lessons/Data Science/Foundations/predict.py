...
adelie = pd.read_csv('/Applications/Code/Codecademy/Lessons/Data Science/Foundations/CSV files/adelie.csv')
adelie['Species'] = 'Adelie'

gentoo = pd.read_csv('/Applications/Code/Codecademy/Lessons/Data Science/Foundations/CSV files/gentoo.csv')
gentoo['Species'] = 'Gentoo'

chinstrap = pd.read_csv('/Applications/Code/Codecademy/Lessons/Data Science/Foundations/CSV files/chinstrap.csv')
